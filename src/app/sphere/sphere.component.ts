...
export class SphereComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    function Particle(this: any, context:any) {
      ...
      this.setPosition = function (x:any, y:any) {
        this.x = x;
        this.y = y;
      };

      // Function to set the velocity.
      this.setVelocity = function (x:any, y:any) {
        this.xVelocity = x;
        this.yVelocity = y;
      };

      this.setImage = function (image:any) {
        this.image = image;
      };
    }

    // A function to generate a random number between 2 values
    function generateRandom(min:any, max:any) {
    ...
    function init() {
      ...
      if (canvas.getContext) {
        ...
        for (var i = 0; i < particleCount; ++i) {
          var particle = new (Particle as any)(context);
